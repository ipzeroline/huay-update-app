...
export const DICT: Record<Lang, Dict> = {
  th: {
    ...
    menuExchangeRate: 'อัตราแลกเปลี่ยนวันนี้',
  ...
  en: {
    ...
    menuExchangeRate: 'Today Exchange Rates',
  ...
  la: {
    ...
    menuExchangeRate: 'ອັດຕາແລກປ່ຽນມື້ນີ້',
  ...
  kh: {
    ...
    menuExchangeRate: 'អត្រាប្តូរប្រាក់ថ្ងៃនេះ',
